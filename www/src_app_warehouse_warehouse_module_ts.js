"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["src_app_warehouse_warehouse_module_ts"],{
...
class ApiService {
    ...
    handleErrors(error) {
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.throwError)(() => console.error(error));
    }
    get(path, params = {}) {
        return this.http
            .get(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.backend}/${path}`, { params })
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleErrors));
    }
    post(path, body = {}) {
        return this.http
            .post(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.backend}/${path}`, body)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleErrors));
    }
    put(path, body = {}) {
        return this.http
            .put(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.backend}/${path}`, body)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleErrors));
    }
    delete(path) {
        return this.http
            .delete(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.backend}/${path}`)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleErrors));
    }
}
...
/* harmony import */ var src_app_core_api_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/app/core/api.service */ 79274);
...
class ContentService {
    ...
    getProductsDetail(externalIds, locale = 'en') {
...
ContentService.ɵfac = function ContentService_Factory(t) { return new (t || ContentService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](src_app_core_api_service__WEBPACK_IMPORTED_MODULE_0__.ApiService)); };
ContentService.ɵprov = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ token: ContentService, factory: ContentService.ɵfac, providedIn: 'root' });
...
/* harmony import */ var src_app_models_ship__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/app/models/ship */ 16107);
...
class NftService {
    ...
    addNFTAssetIDToShips(ships) {
        if (ships.length) {
            return this.getNFTAssetsByIds(ships.map(ship => ship.assetId))
                .pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)((nftAssets) => ships.map((ship, i) => {
                const nft = nftAssets.find(nftAsset => nftAsset.asset_id === ship.assetId);
                return new src_app_models_ship__WEBPACK_IMPORTED_MODULE_0__.Ship(Object.assign(Object.assign({}, ship), { 
                    // eslint-disable-next-line @typescript-eslint/naming-convention
                    NFTAssetID: nft === null || nft === void 0 ? void 0 : nft.nft_asset_id }));
            })), (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.take)(1));
        }
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.of)(ships);
    }
    getAssetsByNFTIds(nftAssetIds) {
        if (nftAssetIds.length === 0) {
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.of)([]);
        }
        return this.http
            .post(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.nftServiceBaseURL}/assets/specific/multiple`, 
        // eslint-disable-next-line @typescript-eslint/naming-convention
        nftAssetIds.map(nftAssetId => ({ nft_asset_id: nftAssetId })));
    }
    getNFTAssetsByIds(assetIds) {
        return this.http.post(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.nftServiceBaseURL}/items/find`, assetIds);
    }
}
NftService.ɵfac = function NftService_Factory(t) { return new (t || NftService)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_6__.HttpClient)); };
NftService.ɵprov = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjectable"]({ token: NftService, factory: NftService.ɵfac, providedIn: 'root' });
...
class Ship {
    ...
    static fromShipTemplate(shipData, instanceID, updatedAt) {
        ...
        return new Ship({
            ...
            Force: (_a = shipData.force) === null || _a === void 0 ? void 0 : _a.name,
            Class: shipData.class,
            Images: {
                Top: (_b = shipData.art_assets) === null || _b === void 0 ? void 0 : _b.top,
                Back: (_c = shipData.art_assets) === null || _c === void 0 ? void 0 : _c.back,
                Front: (_d = shipData.art_assets) === null || _d === void 0 ? void 0 : _d.front,
                Bottom: (_e = shipData.art_assets) === null || _e === void 0 ? void 0 : _e.bottom
            },
            ...
            Abilities: ((_g = (_f = shipData.technical_details) === null || _f === void 0 ? void 0 : _f.abilities) === null || _g === void 0 ? void 0 : _g.map(ability => ({
                Name: ability.name,
                Value: ability.value,
                Image: ability.image
            }))) || [],
...
Ship.INSTANCE_ID_LENGTH = 8;
Ship.SHIP_ID_LENGTH = 14; // Actually this should be named categoryId, but requires a change in the model in the Platform...
Ship.SERIAL_NUMBER_LENGTH = 22; // This is actually the ship (asset) id
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WarehousePageRoutingModule": () => (/* binding */ WarehousePageRoutingModule)
/* harmony export */ });
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ 52816);
/* harmony import */ var _warehouse_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./warehouse.page */ 92250);
...
const routes = [
    {
        path: '',
        component: _warehouse_page__WEBPACK_IMPORTED_MODULE_0__.WarehousePage
    },
    {
        path: 'ship-deposit',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_warehouse_ship-deposit_ship-deposit_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./ship-deposit/ship-deposit.module */ 40933)).then(m => m.ShipDepositPageModule)
    },
    {
        path: 'ship-withdraw',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_warehouse_ship-withdraw_ship-withdraw_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./ship-withdraw/ship-withdraw.module */ 71505)).then(m => m.ShipWithdrawPageModule)
    }
];
class WarehousePageRoutingModule {
}
WarehousePageRoutingModule.ɵfac = function WarehousePageRoutingModule_Factory(t) { return new (t || WarehousePageRoutingModule)(); };
WarehousePageRoutingModule.ɵmod = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({ type: WarehousePageRoutingModule });
WarehousePageRoutingModule.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule.forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](WarehousePageRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule] }); })();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WarehousePageModule": () => (/* binding */ WarehousePageModule)
/* harmony export */ });
...
/* harmony import */ var src_app_core_wallet_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/core/wallet.service */ 75282);
/* harmony import */ var _warehouse_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./warehouse-routing.module */ 35400);
/* harmony import */ var _warehouse_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./warehouse.page */ 92250);
...
class WarehousePageModule {
}
WarehousePageModule.ɵfac = function WarehousePageModule_Factory(t) { return new (t || WarehousePageModule)(); };
WarehousePageModule.ɵmod = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineNgModule"]({ type: WarehousePageModule });
WarehousePageModule.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjector"]({ providers: [src_app_core_wallet_service__WEBPACK_IMPORTED_MODULE_1__.WalletService], imports: [[
            _angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule,
            src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_0__.SharedModule,
            _warehouse_routing_module__WEBPACK_IMPORTED_MODULE_2__.WarehousePageRoutingModule,
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵsetNgModuleScope"](WarehousePageModule, { declarations: [_warehouse_page__WEBPACK_IMPORTED_MODULE_3__.WarehousePage], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule,
        _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule,
        _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule,
        src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_0__.SharedModule,
        _warehouse_routing_module__WEBPACK_IMPORTED_MODULE_2__.WarehousePageRoutingModule] }); })();
...
/***/ 92250:
/*!*********************************************!*\
  !*** ./src/app/warehouse/warehouse.page.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WarehousePage": () => (/* binding */ WarehousePage)
/* harmony export */ });
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! rxjs */ 70679);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! rxjs */ 60116);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! rxjs */ 59295);
...
/* harmony import */ var _warehouse_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./warehouse.service */ 76805);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @angular/router */ 52816);
/* harmony import */ var src_app_core_wallet_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/wallet.service */ 75282);
/* harmony import */ var src_app_core_loading_indicator_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/loading-indicator.service */ 72028);
/* harmony import */ var src_app_core_flagsmith_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/core/flagsmith.service */ 64397);
...
const _c0 = ["warehouseContainer"];
function WarehousePage_div_1_Template(rf, ctx) { if (rf & 1) {
...
class WarehousePage extends src_app_shared_base_page_base_page_component__WEBPACK_IMPORTED_MODULE_1__.BasePageComponent {
    constructor(warehouseService, renderer2, router, walletService, loadingIndicatorService, flagsmithService) {
        super();
    ...
    generateWarehouseWebComponent() {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.forkJoin)({
            ...
            .pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_8__.switchMap)(({ ships, hasWallet }) => {
            if (hasWallet) {
                return this.walletService.getINFBalance()
                    .pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_9__.map)(infBalance => ({ ships, hasWallet, infBalance })));
            }
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_10__.of)({ ships, hasWallet, infBalance: 0 });
        }), (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.takeUntil)(this.destroy$), (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.finalize)(() => this.loadingIndicatorService.stopLoading('generateWarehouseWebComponent')))
            .subscribe(({ ships, hasWallet, infBalance }) => {
            __webpack_require__.e(/*! import() */ "node_modules_pixelmatic_inf-web-components_inf-wcomp-warehouse_js").then(__webpack_require__.t.bind(__webpack_require__, /*! @pixelmatic/inf-web-components/inf-wcomp-warehouse.js */ 41330, 23))
                .then(() => {
    ...
    renderWarehouseWebComponent(ships, hasWallet, infBalance) {
        const shipDepositEnabled = this.flagsmithService.getFlag(src_app_models_flagsmith_types__WEBPACK_IMPORTED_MODULE_0__.Flags.shipDeposit).enabled;
        const shipWithdrawEnabled = this.flagsmithService.getFlag(src_app_models_flagsmith_types__WEBPACK_IMPORTED_MODULE_0__.Flags.shipWithdraw).enabled;
    ...
    handleShipWithdrawCallback() {
        this.router.events
            .pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_13__.pairwise)(), 
        // @ts-ignore
        (0,rxjs__WEBPACK_IMPORTED_MODULE_14__.filter)(([navigationEnd]) => navigationEnd.url === '/tabs/warehouse/ship-withdraw'), 
        // @ts-ignore
        (0,rxjs__WEBPACK_IMPORTED_MODULE_14__.filter)(() => { var _a, _b, _c; return (_c = (_b = (_a = this.router.getCurrentNavigation()) === null || _a === void 0 ? void 0 : _a.extras) === null || _b === void 0 ? void 0 : _b.state) === null || _c === void 0 ? void 0 : _c.withDrawRequestSuccess; }), (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.takeUntil)(this.destroy$), (0,rxjs__WEBPACK_IMPORTED_MODULE_15__.take)(1))
            .subscribe(() => {
            this.renderer2.removeChild(this.warehouseContainer.nativeElement, this.warehouseElement);
            this.generateWarehouseWebComponent();
        });
    }
}
WarehousePage.ɵfac = function WarehousePage_Factory(t) { return new (t || WarehousePage)(_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_warehouse_service__WEBPACK_IMPORTED_MODULE_2__.WarehouseService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_6__.Renderer2), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_16__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](src_app_core_wallet_service__WEBPACK_IMPORTED_MODULE_3__.WalletService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](src_app_core_loading_indicator_service__WEBPACK_IMPORTED_MODULE_4__.LoadingIndicatorService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](src_app_core_flagsmith_service__WEBPACK_IMPORTED_MODULE_5__.FlagsmithService)); };
WarehousePage.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({ type: WarehousePage, selectors: [["app-warehouse"]], viewQuery: function WarehousePage_Query(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵviewQuery"](_c0, 7);
    } if (rf & 2) {
        let _t;
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵloadQuery"]()) && (ctx.warehouseContainer = _t.first);
    } }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵInheritDefinitionFeature"]], decls: 4, vars: 1, consts: [["overflow-scroll", "false"], ["class", "loading-indicator", 4, "ngIf"], [1, "warehouse-container"], ["warehouseContainer", ""], [1, "loading-indicator"], ["src", "assets/images/logo.svg", "alt", "Logo", 1, "logo", "blur-out", "position-absolute", "top-50", "start-50", "translate-middle"]], template: function WarehousePage_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "ion-content", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](1, WarehousePage_div_1_Template, 2, 0, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelement"](2, "div", 2, 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("ngIf", ctx.loadingIndicatorService.isLoading("generateWarehouseWebComponent"));
    } }, directives: [_ionic_angular__WEBPACK_IMPORTED_MODULE_17__.IonContent, _angular_common__WEBPACK_IMPORTED_MODULE_18__.NgIf], styles: [".warehouse-container[_ngcontent-%COMP%] {\n  padding: 3rem 1rem 0 1rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
/***/ 76805:
/*!************************************************!*\
  !*** ./src/app/warehouse/warehouse.service.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var src_app_models_ship__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/models/ship */ 16107);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var src_app_core_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/core/api.service */ 79274);
/* harmony import */ var src_app_core_content_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/content.service */ 28802);
/* harmony import */ var src_app_core_nft_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/nft.service */ 49775);
/* harmony import */ var src_app_core_wallet_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/core/wallet.service */ 75282);
...
class WarehouseService {
    constructor(apiService, contentService, nftService, walletService) {
        this.apiService = apiService;
        this.contentService = contentService;
        this.nftService = nftService;
        this.walletService = walletService;
    }
    getShipTemplate(assetID) {
        return this.contentService.getProductsDetail([assetID.slice(0, 14)])
            .pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_6__.map)(shipData => src_app_models_ship__WEBPACK_IMPORTED_MODULE_1__.Ship.fromShipTemplate(shipData[0], assetID.slice(-8))));
    }
    getShips() {
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.forkJoin)({
            ...
            .pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_6__.map)(({ inventoryShips, walletShips }) => [...inventoryShips, ...walletShips]
            .sort((a, b) => b.UpdatedAt - a.UpdatedAt)));
    }
    getInventoryShips() {
        return this.apiService.get('ships')
            .pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_6__.map)(response => { var _a; return ((_a = response === null || response === void 0 ? void 0 : response.data) === null || _a === void 0 ? void 0 : _a.assets) || []; }), (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.switchMap)(assets => this.hidrateShipData(assets)), (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.take)(1));
    }
    getWalletShips() {
        return this.walletService.getBalances()
            .pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_6__.map)(balances => balances.filter(balance => balance.isNFT)), (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.switchMap)((balances) => this.nftService.getAssetsByNFTIds(balances.map(balance => balance.assetId))), (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.switchMap)((assets) => this.contentService
            .getProductsDetail(this.mapAssetsToExternalIds(assets))
            .pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_6__.map)(shipTemplates => shipTemplates.map((template, i) => {
            const ship = src_app_models_ship__WEBPACK_IMPORTED_MODULE_1__.Ship.fromShipTemplate(template, assets[i].asset_id.slice(-8));
            ship.UpdatedAt = luxon__WEBPACK_IMPORTED_MODULE_0__.DateTime.fromISO(assets[i].updated_at, { zone: 'utc' }).toMillis() * 1000000;
            return ship;
        })))), (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.take)(1));
    }
    hidrateShipData(assets) {
        ...
        return this.contentService.getProductsDetail(this.mapAssetsToExternalIds(assets))
            .pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_6__.map)(shipTemplates => this.mapAssetsToShips(assets, shipTemplates)), (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.switchMap)(ships => this.nftService.addNFTAssetIDToShips(ships)), (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.take)(1));
    }
    mapAssetsToExternalIds(assets) {
        return assets.map(asset => asset === null || asset === void 0 ? void 0 : asset.asset_id.slice(0, src_app_models_ship__WEBPACK_IMPORTED_MODULE_1__.Ship.SHIP_ID_LENGTH));
    }
    mapAssetsToShips(assets, shipTemplates) {
        return assets
            .map(asset => {
            var _a, _b;
            const template = shipTemplates.find(t => t.external_id === asset.asset_id.slice(0, src_app_models_ship__WEBPACK_IMPORTED_MODULE_1__.Ship.SHIP_ID_LENGTH));
            if (template) {
                const seconds = (_a = asset.owner_updated_at) === null || _a === void 0 ? void 0 : _a.seconds.low;
                const nanos = (_b = asset.owner_updated_at) === null || _b === void 0 ? void 0 : _b.nanos;
                const updatedAt = +`${seconds}${nanos}`;
                return src_app_models_ship__WEBPACK_IMPORTED_MODULE_1__.Ship.fromShipTemplate(template, asset.asset_id.slice(-8), updatedAt);
            }
...
WarehouseService.ɵfac = function WarehouseService_Factory(t) { return new (t || WarehouseService)(_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵinject"](src_app_core_api_service__WEBPACK_IMPORTED_MODULE_2__.ApiService), _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵinject"](src_app_core_content_service__WEBPACK_IMPORTED_MODULE_3__.ContentService), _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵinject"](src_app_core_nft_service__WEBPACK_IMPORTED_MODULE_4__.NftService), _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵinject"](src_app_core_wallet_service__WEBPACK_IMPORTED_MODULE_5__.WalletService)); };
WarehouseService.ɵprov = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineInjectable"]({ token: WarehouseService, factory: WarehouseService.ɵfac, providedIn: 'root' });
...
/* harmony export */ });
/* harmony import */ var _duration_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./duration.js */ 14952);
/* harmony import */ var _interval_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./interval.js */ 19705);
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./settings.js */ 73521);
/* harmony import */ var _info_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./info.js */ 23324);
/* harmony import */ var _impl_formatter_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./impl/formatter.js */ 39463);
/* harmony import */ var _zones_fixedOffsetZone_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./zones/fixedOffsetZone.js */ 12521);
/* harmony import */ var _impl_locale_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./impl/locale.js */ 48444);
/* harmony import */ var _impl_util_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./impl/util.js */ 72224);
/* harmony import */ var _impl_zoneUtil_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./impl/zoneUtil.js */ 11419);
/* harmony import */ var _impl_diff_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./impl/diff.js */ 78128);
/* harmony import */ var _impl_regexParser_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./impl/regexParser.js */ 73811);
/* harmony import */ var _impl_tokenParser_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./impl/tokenParser.js */ 36969);
/* harmony import */ var _impl_conversions_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./impl/conversions.js */ 89001);
/* harmony import */ var _impl_formats_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./impl/formats.js */ 31784);
/* harmony import */ var _errors_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./errors.js */ 69508);
/* harmony import */ var _impl_invalid_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./impl/invalid.js */ 97754);
...
/* harmony export */ });
/* harmony import */ var _errors_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./errors.js */ 69508);
/* harmony import */ var _impl_formatter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./impl/formatter.js */ 39463);
/* harmony import */ var _impl_invalid_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./impl/invalid.js */ 97754);
/* harmony import */ var _impl_locale_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./impl/locale.js */ 48444);
/* harmony import */ var _impl_regexParser_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./impl/regexParser.js */ 73811);
/* harmony import */ var _impl_util_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./impl/util.js */ 72224);
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./settings.js */ 73521);
...
/* harmony export */ });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util.js */ 72224);
/* harmony import */ var _invalid_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./invalid.js */ 97754);
...
/* harmony export */ });
/* harmony import */ var _formats_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./formats.js */ 31784);
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./util.js */ 72224);
...
/* harmony export */ });
/* harmony import */ var _english_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./english.js */ 80892);
/* harmony import */ var _formats_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./formats.js */ 31784);
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./util.js */ 72224);
...
/* harmony export */ });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util.js */ 72224);
/* harmony import */ var _english_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./english.js */ 80892);
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../settings.js */ 73521);
/* harmony import */ var _datetime_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../datetime.js */ 93445);
/* harmony import */ var _zones_IANAZone_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../zones/IANAZone.js */ 61985);
...
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util.js */ 72224);
/* harmony import */ var _english_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./english.js */ 80892);
/* harmony import */ var _zones_fixedOffsetZone_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../zones/fixedOffsetZone.js */ 12521);
/* harmony import */ var _zones_IANAZone_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../zones/IANAZone.js */ 61985);
...
/* harmony export */ });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util.js */ 72224);
/* harmony import */ var _formatter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./formatter.js */ 39463);
/* harmony import */ var _zones_fixedOffsetZone_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../zones/fixedOffsetZone.js */ 12521);
/* harmony import */ var _zones_IANAZone_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../zones/IANAZone.js */ 61985);
/* harmony import */ var _datetime_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../datetime.js */ 93445);
/* harmony import */ var _digits_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./digits.js */ 30969);
/* harmony import */ var _errors_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../errors.js */ 69508);
...
/* harmony export */ });
/* harmony import */ var _zone_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../zone.js */ 34225);
/* harmony import */ var _zones_IANAZone_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../zones/IANAZone.js */ 61985);
/* harmony import */ var _zones_fixedOffsetZone_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../zones/fixedOffsetZone.js */ 12521);
/* harmony import */ var _zones_invalidZone_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../zones/invalidZone.js */ 15394);
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./util.js */ 72224);
/* harmony import */ var _zones_systemZone_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../zones/systemZone.js */ 74557);
/**
 * @private
 */
...
/* harmony export */ });
/* harmony import */ var _datetime_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./datetime.js */ 93445);
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./settings.js */ 73521);
/* harmony import */ var _impl_locale_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./impl/locale.js */ 48444);
/* harmony import */ var _zones_IANAZone_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./zones/IANAZone.js */ 61985);
/* harmony import */ var _impl_zoneUtil_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./impl/zoneUtil.js */ 11419);
/* harmony import */ var _impl_util_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./impl/util.js */ 72224);
...
/* harmony export */ });
/* harmony import */ var _datetime_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./datetime.js */ 93445);
/* harmony import */ var _duration_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./duration.js */ 14952);
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./settings.js */ 73521);
/* harmony import */ var _errors_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./errors.js */ 69508);
/* harmony import */ var _impl_invalid_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./impl/invalid.js */ 97754);
...
/* harmony import */ var _datetime_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./datetime.js */ 93445);
/* harmony import */ var _duration_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./duration.js */ 14952);
/* harmony import */ var _interval_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./interval.js */ 19705);
/* harmony import */ var _info_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./info.js */ 23324);
/* harmony import */ var _zone_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./zone.js */ 34225);
/* harmony import */ var _zones_fixedOffsetZone_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./zones/fixedOffsetZone.js */ 12521);
/* harmony import */ var _zones_IANAZone_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./zones/IANAZone.js */ 61985);
/* harmony import */ var _zones_invalidZone_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./zones/invalidZone.js */ 15394);
/* harmony import */ var _zones_systemZone_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./zones/systemZone.js */ 74557);
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./settings.js */ 73521);
...
/* harmony export */ });
/* harmony import */ var _zones_systemZone_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./zones/systemZone.js */ 74557);
/* harmony import */ var _zones_IANAZone_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./zones/IANAZone.js */ 61985);
/* harmony import */ var _impl_locale_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./impl/locale.js */ 48444);
/* harmony import */ var _impl_zoneUtil_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./impl/zoneUtil.js */ 11419);
...
/* harmony export */ });
/* harmony import */ var _impl_util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../impl/util.js */ 72224);
/* harmony import */ var _zone_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../zone.js */ 34225);
